...
import MacroUtil from ".";
import { commentNodes } from "./node";
...
export function prereqFromType(
    ...
    sourcePath = MacroUtil.fixPath(state.project.relativeFromDir(sourcePath));
    ...
    commentNodes(state, declaration, guardDeclareStmt, `guard for ${sourcePath}`);
    return guard;
